...
(function () {
  ...
  serial["CP210x"] = async function (
    obj,
    baudRate = config.DEFAULT_BAUD_RATE
  ) {};

  serial["CP2105"] = async function (
    obj,
    baudRate = config.DEFAULT_BAUD_RATE
  ) {};

  serial["CP2108"] = async function (
    obj,
    baudRate = config.DEFAULT_BAUD_RATE
  ) {};

  serial["PL2303"] = async function (
    obj,
    baudRate = config.DEFAULT_BAUD_RATE
  ) {};
  ...
  serial["FT232H"] = async function (
    obj,
    baudRate = config.DEFAULT_BAUD_RATE
  ) {};

  serial["FT231X"] = async function (
    obj,
    baudRate = config.DEFAULT_BAUD_RATE
  ) {};
})();
